<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPreCommActivities.aspx.cs" Inherits="WebApplication1.Trial" %>
...
<body>
    ...
    <div class="login">
        ...
        <form class="login-container" runat="server">
            ...
            <asp:RequiredFieldValidator ID="rfvName" runat="server" ErrorMessage="Project Name is required" ControlToValidate="ProjectNameDdl">*</asp:RequiredFieldValidator>
            ...
            Pre-Commissioning Activities (hold 'ctrl' key to select multiple forms)<br />
