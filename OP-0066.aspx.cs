...
{
    public partial class OP_0066 : System.Web.UI.Page
    {
        ...
        protected void SubmitBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "Insert_OP0066";
                //Top part of form
                ...
                command.Parameters.AddWithValue("Chk_CT_VT", RadioButtonList12.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Protection_Relay_Diagram", RadioButtonList13.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Protection_Relay_Tag", RadioButtonList14.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Interconnection_Wiring", RadioButtonList15.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Fuses", RadioButtonList16.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Power_Cables", RadioButtonList17.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Vendor_Special_Tools", RadioButtonList18.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Supplier_Documentation", RadioButtonList19.SelectedItem.Text);
                command.Parameters.AddWithValue("Produce_Markedup_Drawing", RadioButtonList20.SelectedItem.Text);
