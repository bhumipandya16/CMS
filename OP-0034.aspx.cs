...
{
    public partial class AirDrying_OP0034 : System.Web.UI.Page
    {
        ...
        protected void SubmitBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "Insert_OP0034";
                //Top part of form
                ...
                command.Parameters.AddWithValue("Method", MethodTxtBox.Text);
                command.Parameters.AddWithValue("Air_Type", AirTypeTxtBox.Text);
