<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OP-0034.aspx.cs" Inherits="WebApplication1.AirDrying_OP0034" %>
...
<body>
    <h2 class="h2"><asp:Label ID="Label49" runat="server" Text="OP-0034"></asp:Label>: Air drying of systems and lines</h2>
        ...
        <div class="container">
            <div class="align">
                <table class="table_width" border="1">
                    ...
                    <tr>
                        <td class="auto-style14"><b>Method Used:</b></td>
                        <td>
                            <asp:TextBox ID="MethodTxtBox" runat="server" Width="100%"></asp:TextBox>
                        </td>
                    </tr>

                    <tr>
                        <td class="auto-style14"><b>Type of air:</b></td>
                        <td>
                            <asp:TextBox ID="AirTypeTxtBox" runat="server" Width="100%"></asp:TextBox>
                        </td>
                   </tr>
              </table>
            </div>
