...
{
    public partial class AddCommActivities : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                using (SqlConnection conn = new SqlConnection())
                {
                    ...
                    {
                        cmd1.CommandText = "SELECT * FROM Form_Comm";
        ...
        protected void AddButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "InsertFormComm";
                ...
                command.Parameters.AddWithValue("@Forms_Comm", System_Name);
