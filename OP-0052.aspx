<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OP-0052.aspx.cs" Inherits="WebApplication1.OP_0052" %>
...
<body>
    <h2 class="h2"><asp:Label ID="Label49" runat="server" Text="OP-0052"></asp:Label>: Steam blowing</h2>
        ...
        <div class="container">
            <div class="align">
                <table class="table_width" border="1">
                    ...
                    <tr>
                        <td class="auto-style14"><b>Type of steam used:</b></td>
                        <td>
                            <asp:CheckBoxList ID="CheckBoxList1" runat="server" RepeatDirection="Horizontal">
                            <Items>
                            <asp:ListItem Text="LP steam" Value="LP steam"></asp:ListItem>
                            <asp:ListItem Text="HP steam" Value="HP steam"></asp:ListItem>
                            </Items>
                            </asp:CheckBoxList>
                        </td>
                    </tr>
