<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OP-0081.aspx.cs" Inherits="WebApplication1.OP_0081" %>
...
<body>
    <h2 class="h2">
        ...
        <asp:Label ID="FormLbl" runat="server" Text="OP-0081"></asp:Label>: Inerting test commissioning checklist</h2>
...
<%--                            <asp:TextBox ID="SystemTxtBox" runat="server" required="required" Width="100%"></asp:TextBox></td>--%>
                    ...
                    <tr>
                        <td class="auto-style14"><b>Design Operating Pressure:</b></td>
                        <td>
                            <asp:TextBox ID="OpPressureTxtBox" runat="server" required="required" Width="100%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style14"><b>Expected test duration:</b></td>
                        <td>
                            <asp:TextBox ID="ExpTestDurationTxtBox" runat="server" required="required" Width="100%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style14"><b>Actual test duartion:</b></td>
                        <td>
                            <asp:TextBox ID="ActualTestDurationTxtBox" runat="server" required="required" Width="100%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style14"><b>Pressure unit:</b></td>
                        <td>
                            <asp:TextBox ID="PressureTxtBox" runat="server" required="required" Width="100%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style17"><b>Time unit:</b></td>
                        <td>
                            <asp:TextBox ID="TimeTxtBox" runat="server" required="required" Width="100%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style14"><b>Test fluid used:</b></td>
                        <td class="auto-style15">
                            <asp:CheckBoxList ID="TestFluidChkBox" runat="server" RepeatDirection="Horizontal">
                    ...
                    <tr>
                        <td class="auto-style14"><b>Leak detection method:</b></td>
                        <td class="auto-style15">
                            <asp:CheckBoxList ID="LeakDetectionChkBox" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem>Adhesive tape</asp:ListItem>
                                <asp:ListItem>Soap solution</asp:ListItem>
                                <asp:ListItem>He tracing</asp:ListItem>
                                <asp:ListItem>Other</asp:ListItem>
                            </asp:CheckBoxList>
                        </td>
                    </tr>
            ...
            <table class="table_width" border="1">
                <tr>
                    ...
                    <th class="th">Test Pressure</th>
                    <th class="th">Holding time</th>
                    <th class="th">Actual pressure</th>
                    <th class="th">Pressure drop</th>
                    <th class="th">Leak found?</th>
