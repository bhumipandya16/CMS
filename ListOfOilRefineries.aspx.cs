...
{
    public partial class ListOfProjects : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (dataSet != null)
                {
                    ...
                    {
                        Label1.Text = "There are no Oil Refineries in the system. Please ask your administrator to add a new oil refinery.";
