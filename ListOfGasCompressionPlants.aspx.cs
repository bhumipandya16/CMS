...
{
    public partial class ListOfGasCompressionPlants : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("Select Refinery_id, Name, Project_Type, Owner_Company from dbo.Refinery Where Project_Type='Gas Compression Plant'", sqlConnection);
                ...
                if (dataSet != null)
                {
                    ...
                    {
                        Label1.Text = "There are no Gas Compression Plants in the system. Please ask your administrator to add a new gas compression plant.";
