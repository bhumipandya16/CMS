...
{
    public partial class PumpsAlignmentCold_OP0031 : System.Web.UI.Page
    {
        ...
        protected void SubmitBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "Insert_OP0031";
                ...
                command.Parameters.AddWithValue("Chk_Nameplate_Data", RadioButtonList1.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Installation_Damage", RadioButtonList2.SelectedItem.Text);
                command.Parameters.AddWithValue("Verify_Manufacturer_Info", RadioButtonList3.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Location_Elevation_Orientation", RadioButtonList4.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Pump_Coupling_Baseplate_AuxiliaryPiping", RadioButtonList5.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Pump_Motor_Baseplate", RadioButtonList6.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Pump_Driver_Coupling_Baseplate_Cleanliness", RadioButtonList7.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Preservation", RadioButtonList8.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Installation", RadioButtonList9.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Alignment", RadioButtonList10.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Painting_Insulation", RadioButtonList11.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Earthing_Bonding", RadioButtonList12.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Suction_DischargePipe", RadioButtonList13.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_FreeRotation_ShaftLine", RadioButtonList14.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Strainer", RadioButtonList15.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Space", RadioButtonList16.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Coupling_CouplingGuards", RadioButtonList17.SelectedItem.Text);
                command.Parameters.AddWithValue("Produce_MarkedUpDrawing", RadioButtonList18.SelectedItem.Text);
