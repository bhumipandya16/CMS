<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OP-0032-2.aspx.cs" Inherits="WebApplication1.CompressorAlignmentHot_OP0032_2" %>
...
<body>
    <h2 class="h2">
        ...
        <asp:Label ID="FormLbl" runat="server" Text="OP-0032-2"></asp:Label>: Pre-commissioning checklist for centrifugal compressors (Part-2)</h2>
...
<%--                            <asp:TextBox ID="SystemTxtBox" runat="server" required="required" Width="100%"></asp:TextBox></td>--%>
            ...
            <table class="table_width" border="1">
                <tr>
                    <th class="auto-style9">Description</th>
            ...
            <table class="table_width" border="1">
                <tr>
                    <th class="th"></th>
                    <th class="th"></th>
                    <th class="th">1/2 hr</th>
                    <th class="th">1 hr</th>
                    <th class="th">1- 1/2 hr</th>
                    <th class="th">2 hr</th>
                    <th class="th">2- 1/2 hr</th>
                    <th class="th">3 hr</th>
                </tr>
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label1" runat="server" Text="Lube oil temperature at suction of coolers"></asp:Label></td>
                ...
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label2" runat="server" Text="Lube oil temperature at discharge of coolers"></asp:Label></td>
                    <td class="auto-style7">
                ...
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label3" runat="server" Text="Lube oil temperature from inner journal bearing"></asp:Label></td>
                    <td class="auto-style7">
                ...
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label4" runat="server" Text="Lube oil temperature from outer journal bearing"></asp:Label></td>
                    <td class="auto-style7">
                ...
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label5" runat="server" Text="Lube oil temperature from thrust bearing"></asp:Label></td>
                    <td class="auto-style7">
                ...
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label6" runat="server" Text="Lube oil temperature from gearbox"></asp:Label></td>
                    <td class="auto-style7">
                ...
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label7" runat="server" Text="Inner journal bearing temperature"></asp:Label></td>
                    <td class="auto-style7">
                ...
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label8" runat="server" Text="Outer journal bearing temperature"></asp:Label></td>
                    <td class="auto-style7">
                ...
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label9" runat="server" Text="Thrust bearing temperature"></asp:Label></td>
                    <td class="auto-style7">
                ...
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label10" runat="server" Text="Compressor suction temperature"></asp:Label></td>
                    <td class="auto-style7">
                ...
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label11" runat="server" Text="Compressor discharge temperature"></asp:Label></td>
                    <td class="auto-style7">
                ...
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label12" runat="server" Text="Compressor discharge flowrate"></asp:Label></td>
                    <td class="auto-style7">
                ...
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label13" runat="server" Text="Driver speed"></asp:Label></td>
                    <td class="auto-style7">
                        <asp:TextBox ID="TextBox85" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox86" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox87" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox88" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox89" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox90" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox91" runat="server" Width="100%"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label14" runat="server" Text="Motor driver amps"></asp:Label></td>
                    <td class="auto-style7">
                        <asp:TextBox ID="TextBox92" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox93" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox94" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox95" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox96" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox97" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox98" runat="server" Width="100%"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label15" runat="server" Text="Steam turbine/ Steam consumption"></asp:Label></td>
                    <td class="auto-style7">
                        <asp:TextBox ID="TextBox99" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox100" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox101" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox102" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox103" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox104" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox105" runat="server" Width="100%"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label16" runat="server" Text="Fuel turbine/ Fuel consumption"></asp:Label></td>
                    <td class="auto-style7">
                        <asp:TextBox ID="TextBox106" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox107" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox108" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox109" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox110" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox111" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox112" runat="server" Width="100%"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="auto-style6">
                        <asp:Label ID="Label17" runat="server" Text="Vibration"></asp:Label></td>
                    <td class="auto-style7">
                        <asp:TextBox ID="TextBox113" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox114" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox115" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox116" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox117" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox118" runat="server" Width="100%"></asp:TextBox></td>
                    <td>
                        <asp:TextBox ID="TextBox119" runat="server" Width="100%"></asp:TextBox></td>
                </tr>
            </table>
