...
{
    public partial class Op_0059 : System.Web.UI.Page
    {
        ...
        protected void SubmitBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "Insert_OP0059";
                //Top part of form
                ...
                command.Parameters.AddWithValue("Chk_Pipe_Support", RadioButtonList4.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Bolting", RadioButtonList5.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Installation_Damage", RadioButtonList6.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Installation_Filter_Cartridge", RadioButtonList7.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Filter_Cartridge_Removal", RadioButtonList8.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Filter_Casing", RadioButtonList9.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Accessibility_Unit", RadioButtonList10.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Painting_Damage", RadioButtonList11.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Earthing_Bonding", RadioButtonList12.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Pipework_Flanges", RadioButtonList13.SelectedItem.Text);
                command.Parameters.AddWithValue("Produce_Markedup_Drawings", RadioButtonList14.SelectedItem.Text);
                command.Parameters.AddWithValue("Produce_Defect_List", RadioButtonList15.SelectedItem.Text);
