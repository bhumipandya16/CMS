<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OP-0069.aspx.cs" Inherits="WebApplication1.OP_0069" %>
...
<body>
    <h2 class="h2">
        <asp:Label ID="Label49" runat="server" Text="OP-0069"></asp:Label>: Low voltage cables pre-commissioning checklist</h2>
    <form id="form2" runat="server" style="border: 1px solid #ccc">
        <div class="container">
            ...
            <table class="table_width" border="1">
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label19" runat="server" Text="Check cable is as specified in project cable schedule."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label2" runat="server" Text="Check cable is correctly loomed and segregated."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label5" runat="server" Text="Check cable gland suit for cable type."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label6" runat="server" Text="Check cable gland plate for single core cables is non-ferrous"></asp:Label></td>
                    <td>
