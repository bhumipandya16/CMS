<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OP-0053.aspx.cs" Inherits="WebApplication1.OP_0053" %>
...
<body>
    <h2 class="h2">
        <asp:Label ID="Label49" runat="server" Text="OP-0053"></asp:Label>: Chemical cleaning</h2>
            ...
            <div class="align">
                <table class="table_width" border="1">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="LinesTxtBox" runat="server" required="required" Width="100%"></asp:TextBox>
                        </td>
                    </tr>

                    <tr>
                        <td class="auto-style14"><b>Cleaning agent::</b></td>
                        <td>
                            <asp:CheckBoxList ID="CheckBoxList1" runat="server" RepeatDirection="Horizontal">
                                <Items>
                                    <asp:ListItem>Degreasing</asp:ListItem>
                                    <asp:ListItem>Inhibited acid</asp:ListItem>
                                    <asp:ListItem>Formulted products</asp:ListItem>
                                    <asp:ListItem>Biocides</asp:ListItem>
                                    <asp:ListItem>Pasivators</asp:ListItem>
                                    <asp:ListItem>Corrosion inhibitors</asp:ListItem>
                                </Items>
                            </asp:CheckBoxList>
                        </td>
                    </tr>
