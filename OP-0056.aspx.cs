...
{
    public partial class OP_0056 : System.Web.UI.Page
    {
        ...
        protected void SubmitBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "Insert_OP0056";
                //Top part of form
                ...
                command.Parameters.AddWithValue("Chk_Tank_Internals_Approved_Drawings", RadioButtonList6.SelectedItem.Text);
                ...
                command.Parameters.AddWithValue("Chk_Pipe_Support", RadioButtonList14.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Disconnected_PipeWork", RadioButtonList15.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Internals", RadioButtonList16.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Roof_Pontoons", RadioButtonList17.SelectedItem.Text);
                command.Parameters.AddWithValue("Verify_Seal_Installation", RadioButtonList18.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_RoofSupport_RoofDrain", RadioButtonList19.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Bolting", RadioButtonList20.SelectedItem.Text);
                command.Parameters.AddWithValue("Produce_Markedup_Drawings", RadioButtonList21.SelectedItem.Text);
