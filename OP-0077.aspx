<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OP-0077.aspx.cs" Inherits="WebApplication1.OP_0077" %>
...
<body>
    <h2 class="h2">
        <asp:Label ID="Label49" runat="server" Text="OP-0077"></asp:Label>: Site Acceptance Test- SAT checklist</h2>
    <form id="form1" runat="server" style="border: 1px solid #ccc">
        <div class="container">
            ...
            <table class="table_width">
                <tr>
                 ...
                 <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label18" runat="server" Text="Is the SAT planning performed?"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label21" runat="server" Text="Are the procedures to carry out the SAT well defined and documented in a proper way?"></asp:Label></td>
                    <td>
