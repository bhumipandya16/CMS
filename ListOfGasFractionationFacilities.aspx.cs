...
{
    public partial class ListOfGasFractionalFacilities : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("Select Refinery_id, Name, Project_Type, Owner_Company from dbo.Refinery Where Project_Type='Gas Fractionation Facility'", sqlConnection);
                ...
                if (dataSet != null)
                {
                    ...
                    {
                        Label1.Text = "There are no Gas Fractionation Facilities in the system. Please ask your administrator to add a new gas fractionation facility.";
