<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OP-0073.aspx.cs" Inherits="WebApplication1.OP_0073" %>
...
<body>
    <h2 class="h2">
        <asp:Label ID="Label49" runat="server" Text="OP-0073"></asp:Label>: Mechanical cleaning</h2>
        ...
        <div class="container">
            <div class="align">
                ...
                <label><b>
                    ...
                    Lines:</b></label>
                <%--<input type="text" id="P&ID" name="P&ID" required="required"/><br />--%>
                <asp:TextBox ID="LinesTxtBox" runat="server" required="required"></asp:TextBox>
            </div>
            <label><b>Cleaning means:</b></label>
            <asp:CheckBoxList ID="CheckBoxList1" runat="server">
                <asp:ListItem>PIG cleaning</asp:ListItem>
                <asp:ListItem>Hydroblasting</asp:ListItem>
            ...
            <table>
                <tr>
                    <td>Acceptance criteria: System must be free of millscale, debris, jointing compounds, metal oxides.</td>
                </tr>
            </table>
            <div class="align">
                <label><b>Visual:</b></label>
                <asp:TextBox ID="VisualTxtBox" runat="server" required="required"></asp:TextBox>

                <label><b>
                    <br />
                    Plate:</b></label>
                <asp:TextBox ID="PlateTxtBox" runat="server" required="required"></asp:TextBox>

                <label><b>
                    <br />
                    QC lab results:</b></label>
                <asp:TextBox ID="LabResultTxtBox" runat="server" required="required"></asp:TextBox>
            </div>
            <table class="table_width">
                <tr>
                    <td>
