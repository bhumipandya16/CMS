...
{
    public partial class OP_0069 : System.Web.UI.Page
    {
        ...
        protected void SubmitBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "Insert_OP0069";
                //Top part of form
                ...
                command.Parameters.AddWithValue("Chk_Cable_Loomed_Segregated", RadioButtonList6.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Cable_Core_Marking", RadioButtonList7.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Cable_Earthing", RadioButtonList8.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Cable_Gland_Suit", RadioButtonList9.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Cable_Gland_Plate", RadioButtonList10.SelectedItem.Text);
                command.Parameters.AddWithValue("Produce_Defect_List", RadioButtonList11.SelectedItem.Text);
