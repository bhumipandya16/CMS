...
{
    public partial class OP_0070 : System.Web.UI.Page
    {
        ...
        protected void SubmitBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "Insert_OP0070";
                //Top part of form
                ...
                command.Parameters.AddWithValue("Chk_Cable_Loomed_Segregated", RadioButtonList5.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Bending_Radius", RadioButtonList6.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Cable_Core_Marking", RadioButtonList7.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Cable_Gland", RadioButtonList8.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Terminations", RadioButtonList9.SelectedItem.Text);
