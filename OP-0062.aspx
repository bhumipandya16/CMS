<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OP-0062.aspx.cs" Inherits="WebApplication1.OP_0062" %>
...
<body>
    <h2 class="h2">
        <asp:Label ID="Label49" runat="server" Text="OP-0062"></asp:Label>: Instrument calibration checklist</h2>
        ...
        <div class="container">
            <div class="align">
                ...
                <table class="table_width" border="1">
                    ...
                    <tr>
                        <td class="auto-style14"><b>Supplier:</b></td>
                        <td>
                            <asp:TextBox ID="SupplierTxtBox" runat="server" required="required" Width="100%"></asp:TextBox></td>
                    </tr>
                    
                    <tr>
                        <td class="auto-style14"><b>No. Certificate:</b></td>
                        <td>
                            <asp:TextBox ID="NoCertificateTxtBox" runat="server" required="required" Width="100%"></asp:TextBox></td>
                    </tr>

                    <tr>
                        <td class="auto-style14"><b>Temperature:</b></td>
                        <td>
                            <asp:TextBox ID="TemperatureTxtBox" runat="server" required="required" Width="100%"></asp:TextBox></td>
                    </tr>
                    
                    <tr>
                        <td class="auto-style14"><b>Pressure:</b></td>
                        <td>
                            <asp:TextBox ID="PressureTxtBox" runat="server" required="required" Width="100%"></asp:TextBox></td>
                    </tr>

                    <tr>
                        <td class="auto-style14"><b>Level:</b></td>
                        <td>
                            <asp:TextBox ID="LevelTxtBox" runat="server" required="required" Width="100%"></asp:TextBox></td>
                    </tr>

                    <tr>
                        <td class="auto-style14"><b>Flow:</b></td>
                        <td>
                            <asp:TextBox ID="FlowTxtBox" runat="server" required="required" Width="100%"></asp:TextBox></td>
                    </tr>
                    </table>
            </div>
            <table class="table_width" border="1">
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label18" runat="server" Text="Check instrument for any damage"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label19" runat="server" Text="Unique identifier for calibration certificate"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label20" runat="server" Text="Identification of equipment being calibrated"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label21" runat="server" Text="Calibration standards are traceable to national or international standards"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label1" runat="server" Text="The calibration records or certificate shows results in full range of instrument measurements"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label2" runat="server" Text="Is the error calculated in each measure"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label3" runat="server" Text="Is the error within the accepted value"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label4" runat="server" Text="Uncertainty of measurement or appropriate statement of compliance is recorder"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label5" runat="server" Text="Calibration within due date "></asp:Label></td>
                    <td>
