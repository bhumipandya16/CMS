<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OP-0059.aspx.cs" Inherits="WebApplication1.Op_0059" %>
...
<body>
    <h2 class="h2"><asp:Label ID="Label49" runat="server" Text="OP-0059"></asp:Label>: Strainer/Filter pre-commissioning checklist</h2>
    <form id="form2" runat="server" style="border: 1px solid #ccc">
        <div class="container">
            ...
            <table class="table_width" border="1">
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label20" runat="server" Text="Check that the holding down arrangements are correct."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label21" runat="server" Text="Check that the pipe-supports are in accordance with the design."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label22" runat="server" Text="Check that the bolting is suitable lubricated."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label23" runat="server" Text="Check that there has been no installation damage."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label24" runat="server" Text="Check that the installation of the filter and cartridge is in accordance with the specifications and approved drawings."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label25" runat="server" Text="Check that the filter and cartridge can be removed when required."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label1" runat="server" Text="Check the filter casing internally for cleanliness."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label2" runat="server" Text="Check the accessibility of the unit for maintenance."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label3" runat="server" Text="Check the painting visualy for any damage."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label4" runat="server" Text="Check that the earthing and bonding are in accordance with the design."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label5" runat="server" Text="Check that when the pipework flanges have been disconnected, that the pipe flanges correctly align with their corresponding filter nozzle flanges."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label6" runat="server" Text="Produce a set of marked-up drawings in accordance with the installation."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label7" runat="server" Text="Produce a defects list for inclusion in the issued punch list."></asp:Label></td>
                    <td>
