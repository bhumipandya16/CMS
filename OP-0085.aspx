<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OP-0085.aspx.cs" Inherits="WebApplication1.OP_0085" %>
...
<body>
    <h2 class="h2">
        <asp:Label ID="Label49" runat="server" Text="OP-0085"></asp:Label>: Hot tie commissioning checklist</h2>
        ...
        <div class="container">
            <div class="align">
                <table class="table_width" border="1">
                    ...
                    <tr>
                        <td class="auto-style14"><b>Pipeline:</b></td>
                        <td>
                            <asp:TextBox ID="PipelineTxtBox" runat="server" required="required" Width="100%"></asp:TextBox></td>
                    </tr>
                    </table>
            </div>

            <table class="table_width" border="1">
                    <tr><th class="th">Location</th>
                        <th class="th">Torque applied</th>
