...
{
    public partial class OP_0063 : System.Web.UI.Page
    {
        ...
        protected void SubmitBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "Insert_OP0063";
                //Top part of form
                ...
                command.Parameters.AddWithValue("Chk_Generator_Data_Conformity", RadioButtonList2.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Preservation_Status", RadioButtonList3.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_General_Mechanical_Arrangement", RadioButtonList4.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Auxiliary_Devices", RadioButtonList5.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Generator_Tagged", RadioButtonList6.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Earthing_Bonding", RadioButtonList7.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Neutral_Earthing", RadioButtonList8.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Power_Auxiliary_Terminal_Cleanliness", RadioButtonList9.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Power_Auxiliary_Terminal_Tightness", RadioButtonList10.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Cable_Glands_Conformity", RadioButtonList11.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Cable_Glands_Correctly_Mounted", RadioButtonList12.SelectedItem.Text);
                command.Parameters.AddWithValue("CarryOut_All_Checks", RadioButtonList13.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Coating_Integrity", RadioButtonList14.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Availability_Of_Certification_Documents", RadioButtonList15.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Supplier_Documentation", RadioButtonList16.SelectedItem.Text);
                command.Parameters.AddWithValue("Produce_Markedup_Drawings", RadioButtonList17.SelectedItem.Text);
                command.Parameters.AddWithValue("Produce_Defect_List", RadioButtonList18.SelectedItem.Text);
