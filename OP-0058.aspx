<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OP-0058.aspx.cs" Inherits="WebApplication1.OP_0058" %>
...
<body>
    <h2 class="h2"><asp:Label ID="Label49" runat="server" Text="OP-0058"></asp:Label>: Fin fan cooler pre-commissioning checklist</h2>
    <form id="form2" runat="server" style="border: 1px solid #ccc">
        <div class="container">
            ...
            <table class="table_width" border="1">
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label19" runat="server" Text="Check the structure for line, level and bolting."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label20" runat="server" Text="Check that all the platforming and ladders are installed in accordance with the approved drawings. If applicable."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label22" runat="server" Text="Check that the exchanger is installed in accordance with the approved drawings."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label23" runat="server" Text="Check that the equipment is bonded in accordance with the approved drawings and specifications."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label24" runat="server" Text="Check that the disconnected pipework flanges correctly align with the nozzle flanges."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label25" runat="server" Text="Check that the bolting is suitable lubricated."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label1" runat="server" Text="Check that the fan shaft is both centered and plumb."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label2" runat="server" Text="Check the belt- sheave alignment."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label3" runat="server" Text="Check the installation and alignment of the fan blades"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label4" runat="server" Text="Check the blade -tip clearances."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label5" runat="server" Text="Check the fan for freedom of rotation."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label6" runat="server" Text="Check that the fan bearings are correctly lubricated."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label7" runat="server" Text="Check that the drive belts are correctly installed."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label15" runat="server" Text="Check that the drive belts guards are in place and secure."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label8" runat="server" Text="Check that the louvres and actuators are correctly installed."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label9" runat="server" Text="Check that the positioners are set correctly and that they are operable."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label10" runat="server" Text="Check that the preservation has been carried out in accordance with the approved procedure."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label11" runat="server" Text="Produce a set of marked-up drawings in accordance with the installation."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label12" runat="server" Text="Produce a defects list for inclusion in the issued punch list."></asp:Label></td>
                    <td>
