...
{
    public partial class OP_0071 : System.Web.UI.Page
    {
        ...
        protected void SubmitBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "Insert_OP0071";
                //Top part of form
                ...
                command.Parameters.AddWithValue("Chk_Motor_DeEnergized", RadioButtonList1.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Preservation_Status", RadioButtonList2.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Motor_Tag", RadioButtonList3.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_General_Mechanical_Arrangement", RadioButtonList4.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Shaft", RadioButtonList5.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Motor_Data", RadioButtonList6.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Motor_Earthing", RadioButtonList7.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Cooling_System", RadioButtonList8.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Phase_Sequence_Connection", RadioButtonList9.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Power_Auxiliary_Terminal_Boxes", RadioButtonList10.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Terminal_Boxes_Screws", RadioButtonList11.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Cable_Glands", RadioButtonList12.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Auxiliary_Devices", RadioButtonList13.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Painting_Integrity", RadioButtonList14.SelectedItem.Text);
                ...
                command.Parameters.AddWithValue("Produce_Defect_List", RadioButtonList17.SelectedItem.Text);
