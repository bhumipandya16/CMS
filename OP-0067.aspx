<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OP-0067.aspx.cs" Inherits="WebApplication1.OP_0067" %>
...
<body>
    <h2 class="h2">
        <asp:Label ID="Label49" runat="server" Text="OP-0067"></asp:Label>: Low voltage switchboard pre-commissioning checklist</h2>
    <form id="form2" runat="server" style="border: 1px solid #ccc">
        <div class="container">
            ...
            <table class="table_width">
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label19" runat="server" Text="Check preservation status and anti-condensation heaters are ready to be energized."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label20" runat="server" Text="Check equipment is correctly aligned, leveled, rigid and secure with correct bolting."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label21" runat="server" Text="Check for missing bolts."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label1" runat="server" Text="Check bus bars supports/ insulators are undamaged and clean. "></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label2" runat="server" Text="Check earthing of all equipment against drawings."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label3" runat="server" Text="Check all covers and cover bolts are correctly fitted, specified IP rating is achieved and danger labels are correctly installed."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label4" runat="server" Text="Produce marked-up drawing in accordance with installation."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label5" runat="server" Text="Produce a defects list for inclusion in the issued punch list."></asp:Label></td>
                    <td>
