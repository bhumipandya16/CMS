...
{
    public partial class OP_0010 : System.Web.UI.Page
    {
        ...
        protected void SubmitBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "Insert_OP0010";
                //Top part of form
                ...
                command.Parameters.AddWithValue("Chk_Equipment_Mounted", RadioButtonList2.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Installation_Damage", RadioButtonList3.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_System_Equipment_Cleanliness", RadioButtonList4.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Preservation", RadioButtonList5.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Pipe_Skid", RadioButtonList6.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Instrumentation_Protection_Device", RadioButtonList7.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_PipingConnection_Alignment", RadioButtonList8.SelectedItem.Text);
                command.Parameters.AddWithValue("Verify_FoundationBolts", RadioButtonList9.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_LubeOilPackage", RadioButtonList10.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_EarthingConnection", RadioButtonList11.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_LubeOilManufacturer", RadioButtonList12.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_LubeOil_InitialLoading_Contingency", RadioButtonList13.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Filters_Coolers", RadioButtonList14.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Cartridges", RadioButtonList15.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_SealLubeOil", RadioButtonList16.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Oil_QualityAnalysis", RadioButtonList17.SelectedItem.Text);
                command.Parameters.AddWithValue("Produce_MarkedUp_Drawings", RadioButtonList18.SelectedItem.Text);
                command.Parameters.AddWithValue("Produce_DefectList", RadioButtonList19.SelectedItem.Text);
