<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OP-0079.aspx.cs" Inherits="WebApplication1.OP_0079" %>
...
<body>
    <h2 class="h2">
        <asp:Label ID="Label49" runat="server" Text="OP-0079"></asp:Label>: Ignition test of burner</h2>
    <form id="form1" runat="server" style="border: 1px solid #ccc">
        <div class="container">
            ...
            <label><b>Type of flame detector used:</b></label>
            <asp:CheckBoxList ID="CheckBoxList1" runat="server">
                <asp:ListItem>Cad cell</asp:ListItem>
                <asp:ListItem>Infrared</asp:ListItem>
                <asp:ListItem>Visible light</asp:ListItem>
                <asp:ListItem>Flame rod</asp:ListItem>
            </asp:CheckBoxList>

            <table class="table_width">
                <tr>
                    <th class="th">Burner No.</th>
                    <th class="th">Run time monitoring</th>
