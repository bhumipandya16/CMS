<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OP-0061.aspx.cs" Inherits="WebApplication1.OP_0061" %>
...
<body>
    <h2 class="h2">
        <asp:Label ID="Label49" runat="server" Text="OP-0061"></asp:Label>: Preservation pre-commissioning checklist</h2>
    <form id="form2" runat="server" style="border: 1px solid #ccc">
        <div class="container">
            ...
            <table class="table_width" border="1">
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label18" runat="server" Text="Check for initial preservation procedure from the Vendor or Manufacturer."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label19" runat="server" Text="Check for instruction from the Vendor or Manufacturer for ongoing preservation."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label20" runat="server" Text="Check for preservation plan in place."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label21" runat="server" Text="Check is preservation is done in accordance with the requirements."></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td class="auto-style13">
                        <asp:Label ID="Label1" runat="server" Text="Proper identification in situ about preservation status."></asp:Label></td>
                    <td>
            ...
            <div class="table_width">
                ...
                <asp:TextBox ID="CommentTxtBox" runat="server" TextMode="MultiLine" Style="height: 150px"></asp:TextBox>
                <table class="table_width" border="1">
                    <tr>
            ...
            <asp:RadioButtonList ID="SubmitRadioButtonList" runat="server" RepeatDirection="Horizontal">
                ...
                <asp:ListItem>False</asp:ListItem>
                    ...
                    <asp:Button class="cancelbtn" ID="SaveBtn" runat="server" Text="Cancel" Width="50%" Float="left" />
