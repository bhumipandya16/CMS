...
{
    public partial class OP_0074 : System.Web.UI.Page
    {
        ...
        protected void SubmitBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "Insert_OP0074";
                //Top part of form
                ...
                command.Parameters.AddWithValue("Chk_Circuit_DeEnergized", RadioButtonList1.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Luminaries_Sockets_Tagging", RadioButtonList2.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Luminaries_Sockets_Mounted", RadioButtonList3.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Luminaries_Sockets_Junction_Boxes_Undamaged", RadioButtonList4.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Luminaries_Sockets_Junction_Boxes_Installed", RadioButtonList5.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Junction_Boxes_Suitably_Plugged", RadioButtonList6.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Cable_Glands_Mounting", RadioButtonList7.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Earthing_Bonding_Equipments", RadioButtonList8.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Cable_Connection", RadioButtonList9.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Earthing_Bonding_Against_Drawings", RadioButtonList10.SelectedItem.Text);
                command.Parameters.AddWithValue("Chk_Circuit_Breaker_Rating", RadioButtonList11.SelectedItem.Text);
                command.Parameters.AddWithValue("Produce_MarkedUp_Drawings", RadioButtonList12.SelectedItem.Text);
                command.Parameters.AddWithValue("Produce_Defect_List", RadioButtonList13.SelectedItem.Text);
